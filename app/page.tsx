...
export default function Home() {
  ...
  const Shell = ({ children }: { children: React.ReactNode }) => (
    <main className="app">
      ...
      <section className="screen"><MobileTop title={pageTitle} back={route !== "/dashboard"} onBack={() => go(route === "/eligibility" || route === "/applications" ? "/dashboard" : "/dashboard")} />{children}</section>
